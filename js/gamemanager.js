let GameManager = {
  ...
  resetPlayer: function(classType) {
    ...
    getInterface.innerHTML = '<img src="image/avatar-players/' +
    classType.toLowerCase() + '.png" class="img-avatar"><div><h3>' + classType + '</h3>' +
  ...
  setFight: function() {
    ...
    getEnemy.innerHTML = '<img src="image/avatar-enemies/' + enemy.enemyType.toLowerCase() + '.png" alt="' +
